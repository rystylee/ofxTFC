...
meta:
    ADDON_NAME = ofxTFC
    ADDON_DESCRIPTION = Addon for TensorFlow C API
    ADDON_AUTHOR = @rystylee
    ADDON_TAGS = "machine learning" "deep learning"
    ADDON_URL = https://github.com/rystylee/ofxTFC
...
vs:
    ...
    ADDON_LIBS += "libs/libtensorflow-gpu-windows-x86_64-1.13.1/lib/tensorflow.lib"
